...
message = {'request': 'define_qos','application': 'exporter','percentage': 60,'slo':'responseTime','type':'>','queue': queue,'deployment':'tester','threshold':110,'prediction':True,'interval':20,'under_utilization_threshold': 20,'dependencies':['prometheus','node_exporter','manager'],'target':{'application':'atos-ml','component':'recommender','host':'pushgateway','port':9091,'labels':{"provider":"atos-wordline"}}}
